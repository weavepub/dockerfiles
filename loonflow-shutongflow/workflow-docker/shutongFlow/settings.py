...
AUTH_LDAP_SERVER_URI = "ldap://ldap.wmq.cn:389"  # ldap服务器地址
AUTH_LDAP_BIND_DN = 'cn=manager,dc=wmq,dc=cn'  # 可为空，也可以填写一个真实的ldap用户
...
STATIC_URL = '/static/'
#STATIC_ROOT = '/usr/local/lib/python3.6/dist-packages/django/contrib/admin/static/'
